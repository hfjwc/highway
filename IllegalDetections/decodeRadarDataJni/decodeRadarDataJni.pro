...
SOURCES += \
    decodeRadarDataJni.cpp

HEADERS += \
    jni.h\
    jni_md.h\
    decodeRadarDataJni.h
...
#unix:!macx: LIBS += -L$$PWD/../../soc-sdk/lib/ -lbmrt -lbmlib -lbmcv -ldl -lbmvideo -lswresample -lswscale -lavformat -lavutil -lavcodec -lpthread -lbmjpuapi -lbmjpulite -lopencv_core -lopencv_imgproc -lopencv_imgcodecs -lopencv_videoio -lopencv_video -lopencv_freetype -lopencv_calib3d -lopencv_highgui
...
unix:!macx: LIBS += -L$$PWD/../release/lib/ -ldecodeRadarData
